...
//
//BOOST_TYPEOF_REGISTER_TEMPLATE(boost::proto::meta::unary_expr, (typename)(typename))
//BOOST_TYPEOF_REGISTER_TEMPLATE(boost::proto::meta::binary_expr, (typename)(typename)(typename))
//
//#endif
